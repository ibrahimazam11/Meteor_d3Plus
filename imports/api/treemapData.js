...
export const httpGet = {  /**** Method to get data from http call ****/
  getTreemapData() {
    return new Promise((res, rej) => {    // create promise for calling api using metor/http package
      HTTP.call("GET", "https://cors-anywhere.herokuapp.com/https://cloud.iexapis.com/stable/stock/xxii/stats?token=pk_bc4c1f923481462fa077c954d1f8b134", {   // get data from api
